...
foreach ($_POST as $nmParam => $valParam) {
    ...
    $sbParam .= "<input type='hidden' name='" . $nmParam . "' value='" . iconv("EUC-KR", "UTF-8", f_get_parm_str($valParam)) . "'/>";
    //$sbParam .= "<input type='text' name='" . $nmParam . "' value='" . f_get_parm_str($valParam) . "'/>";
}
...
if ($res_cd == "0000") {
    ...
    $sbParam .= "<input type='hidden' name='phone_no_real' value='" . $ct_cert->mf_get_key_value("phone_no") . "'/>";
    $sbParam .= "<input type='hidden' name='user_name_real' value='" . iconv("EUC-KR", "UTF-8", $ct_cert->mf_get_key_value("user_name")) . "'/>";
    $sbParam .= "<input type='hidden' name='user_ci' value='" . $ct_cert->mf_get_key_value("ci_url") . "'/>";
