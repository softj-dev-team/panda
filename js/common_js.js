...
// 커서위치에 인서트
function insertCharText(text) {
	curr_sym_focus = (curr_sym_focus != null && curr_sym_focus != "")? curr_sym_focus : 'article_title';
	
	var areaId = curr_sym_focus;
	
	if (typeof(document.getElementById(areaId)) != "undefined") {
