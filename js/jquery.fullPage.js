    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            $body.append('<div id="' + SECTION_NAV + '"><div class=nav_nm>&nbsp;01</div><div align=center><ul></ul></div><div class=bottom_nm style=margin-top:38px>&nbsp;06</div></div>');
        ...
        function activateNavDots(name, sectionIndex){
            ...
            if(options.navigation){
                ...
                if(name){
                    ...
                    // footer 영역으로 이동 시에는스크롤 애니메이션 삭제
                    if (sectionIndex == "5") {
                        $(".scroll_down").hide();
                    } else {
                        $(".scroll_down").show();
