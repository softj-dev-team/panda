...
$total_param = 'bmenu='.$bmenu.'&smenu='.$smenu.'&field='.$field.'&keyword='.$keyword.'&bbs_code='.$bbs_code.'&s_cate_code='.$s_cate_code.'&v_sect='.$v_sect.'&pageNo='.$pageNo;
	...
	$sql_copy = "delete from board_url_copy where 1=1 and board_tbname='board_content' and board_code = '".$bbs_code."' and board_idx='".$idx."' ";
	$query_copy = mysqli_query($gconnet,$sql_copy);

	$sql_copy2 = "delete from board_interest_regist where 1=1 and board_tbname='board_content' and board_code = '".$bbs_code."' and board_idx='".$idx."' ";
	$query_copy2 = mysqli_query($gconnet,$sql_copy2);

	$sql_copy3 = "delete from board_declaration_regist where 1=1 and board_tbname='board_content' and board_code = '".$bbs_code."' and board_idx='".$idx."' ";
	$query_copy3 = mysqli_query($gconnet,$sql_copy3);
