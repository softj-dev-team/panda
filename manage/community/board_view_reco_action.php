...
if($_SESSION['member_homest_idx'] == $row['member_idx']){
	...
	$sql_prev = "select idx from board_reco_cnt where 1=1 and board_tbname='board_content' and board_code = '".$row['bbs_code']."' and board_idx='".$row['idx']."' and member_idx = '".$_SESSION['member_homest_idx']."' ";
