		...
		<div class="container clearfix">
			...
			<table class="t_view">
				...
				<?if($_include_board_write_auth != "AD"){?>
					<tr>
						<th >작성자</th>
						<td colspan="3"><input type="text" style="width:10%;" name="writer" required="yes"  message="작성자" value="<?=$_SESSION['manage_coinc_name']?>"></td>
					</tr>
				<?}?>						
					...
					<tr>
						<th >내 용</th>
						<td colspan="3">
							<textarea placeholder="내용" name="fm_write" id="editor"><?=stripslashes($row[content])?></textarea>
						</td>
					</tr>
