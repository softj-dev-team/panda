...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/function_query.php"; ?><?// include $_SERVER["DOCUMENT_ROOT"]."/plsone_manage/inc/check_login2_sub.php"; ?>
<?
if($_SESSION['manage_supma_id'] != "admin"){ 
?>
