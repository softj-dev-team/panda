					...
					<input type="hidden" name="total_param" value="<?=$total_param?>"/>
						...
						<tr>
							...
							<td><a href="javascript:go_view('<?=$row['idx']?>');">
								SMS : <?=number_format($row['mb_short_fee'])?>
								<br>LMS : <?=number_format($row['mb_long_fee'])?>
								<br>MMS : <?=number_format($row['mb_img_fee'])?>
							</a></td>
							<td><a href="javascript:go_view('<?=$row['idx']?>');"><?=number_format($row['current_point'])?></a></td>
