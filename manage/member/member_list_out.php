...
$where = " and memout_yn in ('Y') and del_yn='N' and member_type in ('GEN') and partner_idx=(select idx from member_info_company where 1 and is_del='N' and member_idx='".$_SESSION['manage_coinc_idx']."')";
