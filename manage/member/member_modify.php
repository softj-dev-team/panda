				...
				<div class="write">
					...
					<table>
						...
						<tr>
							<th scope="row">이름</th>
							<td colspan="3">
								<input type="text" style="width:20%;" name="member_name" id="member_name" required="yes" message="이름" value="<?=$row['user_name']?>">
							</td>
							<!--<th scope="row">닉네임</th>
							<td colspan="3">
						...
						<tr>
							...
							<td colspan="3">
								...
								<input type="text" style="width:30%;" name="cell" id="join_member_cell" onblur="set_cell_num('join_member_cell');" required="yes"  message="연락처" value="<?=$row['cell']?>">
							</td>
						</tr>
						<tr class="address">
								<th scope="col">주소</th>
								...
								<p>
									<input type="text" name="zip_code1" id="zip_code1" value="<?=$row[post]?>" readonly required="no"  message="우편번호" is_num="yes">
								...
								<!-- 우편번호 레이어 종료 -->
								<p>
									<input type="text" name="member_address" id="member_address" value="<?=$row[addr1]?>" style="width:50%;" required="no"  message="기본주소">
									<span class="info">기본주소</span>
								</p>
								<p>
									<input type="text" name="member_address2" id="member_address2" value="<?=$row[addr2]?>" style="width:50%;" required="no"  message="상세주소">
						...
						<tr>
							...
							<input type="hidden" name="partner_id" id="partner_id" value="<?=$_SESSION['manage_coinc_id']?>">
						</tr>
					</table>
					...
					<p class="tit">추가정보</p>
						...
						<tr>
							...
							<td>
								<input type="radio" name="master_ok" value="Y" <?=$row[master_ok]=="Y"?"checked":""?> required="no"  message="승인여부" id="master_ok_1"> 승인
								<input type="radio" name="master_ok" value="N" <?=$row[master_ok]=="N"?"checked":""?> required="no"  message="승인여부" id="master_ok_2"> 미승인
							</td>
							<th scope="row"> 회원구분</th>
							<td>
								<input type="radio" name="member_gubun" value="1" <?=$row[member_gubun]=="1"?"checked":""?> required="no"  message="회원구분" id="member_gubun_1"> 일반회원
								<input type="radio" name="member_gubun" value="2" <?=$row[member_gubun]=="2"?"checked":""?> required="no"  message="회원구분" id="member_gubun_2"> 광고회원
								<input type="radio" name="member_gubun" value="3" <?=$row[member_gubun]=="3"?"checked":""?> required="no"  message="회원구분" id="member_gubun_3"> 휴면회원
							</td>
						</tr>
						<tr>
						...
						?>
								...
								<span class="marr5 marl20">메모 : </span> <input type="text" placeholder="" name="call_memo[]" size="50" value="<?=$call_memo_arr[$i_num]?>">
...
function addForm_2(){
	...
	str+='<span class="marr5 mnw50 dib">발신번호 : </span> <input type="text" placeholder="" name="call_num[]" maxlength="13" id="call_num_'+count_2+'" onchange=check_cell_num("'+count_2+'");>&nbsp;<span class="marr5 marl20">메모 : </span> <input type="text" placeholder="" name="call_memo[]" size="50">&nbsp;<span class="marr5 marl20">상태 : </span> <select name="use_yn[]"><option value="">선택하세요</option><option value="Y">사용가능</option><option value="N">사용불가</option></select>';
