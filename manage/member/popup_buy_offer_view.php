...
<?
	...
	$query_last = "select sale_price_usd,sale_price_won from product_info_sale_offer where 1 and offer_yn_sale='Y' and offer_yn_buy='Y' and is_del='N' and sale_idx='".$row_basic['sale_idx']."'";
		...
		<div class="content" style="position:relative; padding:0 10px 0 10px;">
				...
				<div class="write">
					<table>
							...
							<tr>
								<td colspan="2" style="background-color:#ffffff;">[<?=$row_basic['product_title']?>] 구매내역 보기</td>
								<th scope="row">구매자</th>
