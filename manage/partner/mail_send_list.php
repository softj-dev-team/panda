...
//$where .= " and mail_method = '".$_SESSION['manage_homest_section']."' and mail_gubun = '".$mail_gubun."' ";  
$where .= " and mail_gubun = '".$mail_gubun."' ";  
...
$query = $query." FROM mail_send_msg WITH(NOLOCK) ";
...
$query = "select * from send_msg where 1=1 ".$where.$order_by." limit ".$StarRowNum." , ".$EndRowNum;
//echo "<br><br>쿼리 = ".$query."<br><Br>";
$result = mysqli_query($gconnet,$query);

$query_cnt = "select idx from send_msg where 1=1 ".$where;
...
<!--
	function go_view(no){
		location.href = "mail_send_view.php?mail_key="+no+"&pageNo=<?=$pageNo?>&<?=$total_param?>";
	}
//-->
</SCRIPT>
<body>
