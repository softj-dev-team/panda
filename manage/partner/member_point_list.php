	...
	<div class="sub_wrap">
		...
		<div class="container clearfix">
			...
			<table class="search_list">
				...
				<? if($num==0) { ?>
					<tr>
						<td colspan="10" height="40"><strong>적립대상 가맹점이 없습니다.</strong></td>
					</tr>
				<? } ?>
				...
				<input type="hidden" name="mile_pre" value="<?=$row['current_point']?>"/>
					...
					<tr>
						...
						<td><?=number_format($row['current_point'],0)?> 원</td>
						<td>
