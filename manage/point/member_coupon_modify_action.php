...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/include_htmlheader_manage.php"; ?><? include $_SERVER["DOCUMENT_ROOT"]."/plsone_manage/inc/check_login3_sub.php"; ?>
<?
	...
	$query_mile .= " section = '".$_SESSION['manage_yonex_section']."',";
