	...
	<div class="sub_wrap">
		...
		<div class="container clearfix">
			...
			<?if($_include_board_write_auth != "AD"){?>
					<tr>
						<th>작성자</th>
						<td colspan="3"><input type="text" style="width:20%;" name="writer" required="yes"  message="작성자" value="<?=$_SESSION['manage_coinc_name']?>"></td>
						<!--<th >분류</th>
						<td >
			...
			<?}?>
					<tr>
						<th >내 용 <?//=$_SERVER["DOCUMENT_ROOT"].$_P_DIR_FCKeditor."fckeditor.php"?></th>
						<td colspan="3">
