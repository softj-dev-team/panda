...
if($_SESSION['member_gosm_idx'] == $row['member_idx']){
	...
	$sql_prev = "select idx from board_reco_cnt where 1=1 and board_tbname='board_comment' and board_code = '".$row['board_code']."' and board_idx='".$row['idx']."' and member_idx = '".$_SESSION['member_gosm_idx']."' ";
