		...
		<div class="container clearfix">
			...
			<table class="t_view">
				...
				<?if($row[section] == "img"){?>
					...
					<tr id="link_sect_txt4" style="display:<?=$row['section']=="movie"?"none":""?>;">
						...
						<br>
						<input type="file" id="inputPhoto" name="file1" style="width:50%;" required="no"  message="배너 이미지"/>&nbsp;<font style="color:blue;">최적화 이미지 사이즈 : </font><span id="banner_size_txt1"> 가로 1920 픽셀, 세로 899 픽셀</span></td>
					</tr>
			...
			<?}?>
					<!--<tr>
						...
						<?if($s_sect1 == "pc"){?>
							<option value="탑" <?=$row[main_sect]=="탑"?"selected":""?>>탑배너</option>
							<option value="중앙" <?=$row[main_sect]=="중앙"?"selected":""?>>중앙배너</option>
						<? } elseif($s_sect1 == "mobile"){ ?>
							<option value="메인화면 중앙롤링" <?=$row[main_sect]=="메인화면 중앙롤링"?"selected":""?>>메인화면 중앙롤링</option>
							<option value="좌측메뉴 상단 롤링" <?=$row[main_sect]=="좌측메뉴 상단 롤링"?"selected":""?>>좌측메뉴 상단 롤링</option>
							<option value="메인하단 롤링" <?=$row[main_sect]=="메인하단 롤링"?"selected":""?>>메인하단 롤링</option>
						<? } ?>
							</select>
						</td>
					</tr>-->
