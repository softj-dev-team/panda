		...
		<div class="cont">
			...
			<table class="t_view">
				...
				<?}?>-->
					...
					<tr>
						<th >작성자</th>
						<td colspan="3"><input type="text" style="width:10%;" name="writer" required="yes"  message="작성자" value="<?=$_SESSION['admin_homest_name']?>"></td>
					</tr>
			...
			<div class="align_c margin_t20">
				<!-- 등록 -->
				<a href="javascript:go_submit();" class="btn_blue2">답글등록</a>
				<!-- 목록 -->
