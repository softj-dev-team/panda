...
$where = " and cate_level = '1' and del_ok = 'N' "; // 대분류만 우선 출력
					...
					<!-- 리스트 시작 -->
						...
						<table class="search_list">
							...
							<form method="post" action="cate_write_action.php" name="frm_1" target="_fra_admin" id="frm_1" enctype="multipart/form-data">
								...
								<tr>
									<td>
									<select name="type" style="vertical-align:middle;width:90%;" required="yes" message="옵션타입">
										<option value="">옵션타입 선택</option>
										<option value="section">업종</option>
										<option value="basic">기본옵션</option>
										<option value="period">진행기간</option>
										<option value="display">노출옵션</option>
									</select>	
									</td>
									<td>
										<input type="text" style="width:90%;" name="cate_name1" required="yes" message="옵션이름" value="">
									</td>
									<td>
										<!--<input type="text" style="width:90%;" name="cate_name1" required="yes" message="옵션명" value="">-->
										<textarea style="width:90%;height:80px;" name="cate_name2" required="no" message="옵션설명" placeholder="설명이 필요한 옵션만 입력"></textarea>
									</td>
									<td>
										<input type="text" style="width:90%;" name="cate_desc1" required="no" message="옵션금액" placeholder="금액 반영되는 옵션만 입력" value="">
									</td>
									<td>
						...
						<? if($num==0) { ?>
							<tr>
								<td colspan="10" height="40">등록된 옵션이 없습니다.</strong></td>
							</tr>
						<? } ?>
						<?
						...
						?>
							<form name="frm_cate1_<?=$i?>" method="post" action="cate_modify_action.php"  target="_fra_admin" enctype="multipart/form-data">
								...
								<tr>
									<!--<td><a href="cate_list.php?bmenu=<?=$bmenu?>&smenu=<?=$smenu?>&v_step=2&cate_code1=<?=$row[cate_code1]?>">--><?//=$row[cate_code1]?><!--</a></td>-->
									<td>
									<select name="type" style="vertical-align:middle;width:90%;" required="yes" message="옵션타입">
										<option value="">옵션타입 선택</option>
										<option value="section" <?=$row[type]=="section"?"selected":""?>>업종</option>
										<option value="basic" <?=$row[type]=="basic"?"selected":""?>>기본옵션</option>
										<option value="period" <?=$row[type]=="period"?"selected":""?>>진행기간</option>
										<option value="display" <?=$row[type]=="display"?"selected":""?>>노출옵션</option>
									</select>	
									</td>
									<td>
										<input type="text" style="width:90%;" name="cate_name1" required="yes" message="옵션이름" value="<?=$row[cate_name1]?>">
									</td>
									<td>
										<!--<input type="text" style="width:90%;" name="cate_name1" required="yes" message="옵션명" value="<?=$row[cate_name1]?>">-->
										<textarea style="width:90%;height:80px;" name="cate_name2" required="no" message="옵션설명" placeholder="설명이 필요한 옵션만 입력"><?=$row[cate_name2]?></textarea>
									</td>
									<td><!--<input type="text" style="width:20%;" name="cate_align" required="yes" message="정렬순서" is_num="yes" value="<?=$row[cate_align]?>"> 숫자만 입력, 높은숫자 우선-->
										<input type="text" style="width:90%;" name="cate_desc1" value="<?=$row[cate_desc1]?>" required="no" message="옵션금액" placeholder="금액 반영되는 옵션만 입력">
									</td>
									<td>
										<select name="is_del" id="is_del" required="yes" message="사용여부">
											<option value="N" <?=$row[is_del]=="N"?"selected":""?>>정상사용</option> 
