...
$point_sql = "select  * from member_point_set where 1=1 and coin_type='exper' and point_sect='".$point_sect."' order by idx desc limit 0,1"; // 가장 최근에 설정된 적립비율 설정내용을 가져온다.
...
<div id="wrap" class="skin_type01">
	...
	<div class="sub_wrap">
			...
			<a href="javascript:location.reload();" class="btn_refresh">새로고침</a>
				...
				<div class="write">
					...
					<div class="btn_wrap" style="margin-bottom:10px;">
						<b>체험관련 코인지급 설정입니다. 기대리뷰, 체험리뷰, 체험공유시 지급될 금액만 설정합니다.</b>
					</div>
		...
		<?} elseif($point_sect == "refund"){ // 코인지급일 경우 시작 ?>
				...
				<tr>
					<th>기대리뷰 작성시</th>
					<td>기대리뷰 작성시 <input type="text" name="add_point_1" id="add_point_1" class="input_txt" style="width:100px;" value="<?= $point_row[add_point_1]?>"  required="yes" message="기대리뷰 작성시" is_num="yes"/> 코인지급 (지급하지 않을경우 0 입력)</td>
				</tr>
				<tr>
					<th>체험리뷰 작성시</th>
					<td>체험리뷰 작성시<input type="text" name="add_point_2" id="add_point_2" class="input_txt" style="width:100px;" value="<?= $point_row[add_point_2]?>"  required="yes" message="체험리뷰 작성시" is_num="yes"/> 코인지급 (지급하지 않을경우 0 입력)</td>
				</tr>
				<tr>
					<th>체험공유시</th>
					<td>체험공유시 <input type="text" name="add_point_3" id="add_point_3" class="input_txt" style="width:100px;" value="<?= $point_row[add_point_3]?>"  required="yes" message="체험공유시" is_num="yes"/> 코인지급 (지급하지 않을경우 0 입력)</td>
				</tr>
