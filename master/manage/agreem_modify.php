...
$sql = "select *,(select user_name from member_info where 1 and del_yn='N' and idx=a.admin_idx) as admin_name,(select user_id from member_info where 1 and del_yn='N' and idx=a.admin_idx) as admin_id from agreement_info a where 1 and idx='".$idx."' and is_del='N'";
	...
	<div class="sub_wrap">
		...
		<div class="container clearfix">
			<div class="content">
				...
				<form name="frm" id="frm" action="agreem_modify_action.php" target="_fra_admin" method="post"  enctype="multipart/form-data">
...
<script>
	...
	function go_list(){
		location.href = "agreem_view.php?idx=<?=$idx?>&<?=$total_param?>";
	}
</script>
