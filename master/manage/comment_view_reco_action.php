...
if($_SESSION['member_coinc_idx'] == $row['member_idx']){
	...
	$sql_prev = "select idx from board_reco_cnt where 1=1 and board_tbname='board_comment' and board_code = '".$row['board_code']."' and board_idx='".$row['idx']."' and member_idx = '".$_SESSION['member_coinc_idx']."' ";
	...
	if($cnt_prev == 0){ // 기존에 추천한 내용이 없을때 추천수 증가시킨다 시작 
			...
			$query_reco_cnt .= " member_idx = '".$_SESSION['member_coinc_idx']."', ";
