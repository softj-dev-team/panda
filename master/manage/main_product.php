...
<?
	...
	$where = " and is_del='N' and idx not in (select target_idx from main_select_info where 1 and type='prod' and is_del='N') and idx in (select product_idx from product_info_sale where 1 and is_del='N' and public_ok='Y' and member_idx=product_info.member_idx)";
...
<body>
		...
		<div class="content" style="position:relative; padding:0 10px 0 10px;">
				...
				<!-- 검색창 종료 -->
					...
					<!-- 목록 옵션 종료 -->
				<form action="main_pro_action.php" method="post" name="frm2" id="frm2" target="_fra_admin">
					<input type="hidden" name="type" id="type" value="prod" />
					<table class="search_list">
							...
							?>
								<tr>
									<td><input type="checkbox" name="product_idx[]" id="product_idx_<?=$row['idx']?>" value="<?=$row['idx']?>" required="yes" message="작품"></td>
