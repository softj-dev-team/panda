...
$mb_ft_fee = trim(sqlfilter($_REQUEST['mb_ft_fee']));
$mb_fi_fee = trim(sqlfilter($_REQUEST['mb_fi_fee']));
$mb_fw_fee = trim(sqlfilter($_REQUEST['mb_fw_fee']));
...
if ($prev_cnt == 0) {
    ...
    $query_add .= " mb_ft_fee = '" . $mb_ft_fee . "', ";
    $query_add .= " mb_fi_fee = '" . $mb_fi_fee . "', ";
    $query_add .= " mb_fw_fee = '" . $mb_fw_fee . "', ";
