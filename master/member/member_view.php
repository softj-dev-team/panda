				...
				<div class="content">
					...
					<div class="write">
						...
						<td>
							...
							<tr>
								<th scope="row"> 모듈정보</th>
								<td colspan="3">
									<div>
										SMS : <?php if ($row['sms_module_type'] == "LG") {
													echo "LGHV";
												} else if ($row['sms_module_type'] == "JUD1") {
													echo "JUD1";
												} else if ($row['sms_module_type'] == "JUD2") {
													echo "JUD2";
												}
												?>
									</div>
									<div>
										LMS : <?php if ($row['lms_module_type'] == "LG") {
													echo "LGHV";
												} else if ($row['lms_module_type'] == "JUD1") {
													echo "JUD1";
												} else if ($row['lms_module_type'] == "JUD2") {
													echo "JUD2";
												}
												?>
									</div>
									<div>
										MMS : <?php if ($row['mms_module_type'] == "LG") {
													echo "LGHV";
												} else if ($row['mms_module_type'] == "JUD1") {
													echo "JUD1";
												} else if ($row['mms_module_type'] == "JUD2") {
													echo "JUD2";
												}
												?>
									</div>
	...
	<script type="text/javascript">
		...
		function unlink_photo() {
			...
			$.ajax({
				...
				dataType: "text",
				data: {
					"membership_photo_org": frm_photo.elements["membership_photo_org"].value
				},
				async: true,
				timeout: 9000,
