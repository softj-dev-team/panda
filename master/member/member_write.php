				...
				<form name="frm" action="member_write_action.php" target="_fra_admin" method="post"  enctype="multipart/form-data">
					...
					<p class="tit">기본정보</p>
						...
						<tr>
							<th scope="row">이름</th>
							<td colspan="3">
								<input type="text" style="width:20%;" name="member_name" id="member_name" required="yes" message="이름">
							</td>
							<!--<th scope="row">닉네임</th>
							<td colspan="3">
						...
						<tr>
							...
							<td colspan="3">
								...
								<input type="text" style="width:30%;" name="cell" id="join_member_cell" onblur="set_cell_num('join_member_cell');" required="yes"  message="연락처">
							</td>
						</tr>
						<tr class="address">
								<th scope="col">주소</th>
						...
						<tr>
							<th scope="row">이메일</th>
							<td>
								<input type="text" style="width:60%;" name="member_email" id="member_email" required="yes"  message="이메일" is_email="yes"><!--&nbsp;<a href="javascript:ch_email();" class="btn_green">중복확인</a>
								<div id="check_email" style="paddig-top:10px;"></div>-->
							</td>
							<th scope="row">가맹점 ID</th>
							<td>
								<input type="text" name="partner_id" id="partner_id" required="no" message="가맹점 ID" style="width:80%; ime-mode:disabled">
							</td>
						</tr>
						</table>
