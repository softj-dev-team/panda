...
<?
	...
	$sql_prev = "select * from member_info where 1 and idx='".$_SESSION['admin_coinc_idx']."'";
	...
	if($mode == "resell"){ // 판매재개 
		...
		$query .= " admin_resell = '".$_SESSION['admin_coinc_idx']."'";
	...
	<?
		...
		$query .= " admin_cancel = '".$_SESSION['admin_coinc_idx']."'";
