	...
	<div class="content" style="position:relative; padding:0 10px 0 10px;">
		...
		<div class="write" style="padding: 1px 1px 1px 1px;margin-top:10px;">
			...
			<table style="padding: 1px 1px 1px 1px;">
				...
				<td colspan="3"><?= number_format($row_sub1['current_point'], 2) ?></td>
				</tr>
			</table>
		</div>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><?= number_format($row[mile_pre], 2) ?> 점</td>
								<td><?= $mile_sect ?></td>
								<td><?= number_format($row[chg_mile], 2) ?> 점</td>
								<td><?= number_format($row[cur_mile], 2) ?> 점</td>
								<td><?= $row[wdate] ?></td>
								<td>
