...
<?
	...
	$where = " and is_del='N' and order_num in (select order_num from order_member where 1 and is_del='N' and orderstat='com')";
					...
					<input type="hidden" name="total_param" value="<?=$total_param?>"/>
						...
						<table class="search_list">
							...
							?>
								<tr>
									<td><?=$listnum?></td>
									<td><a href="javascript:go_calc_view('<?=$row['sale_idx']?>');"><?=$row['user_sale']?></a></td>
...
<script>
	...
	function go_calc_view(idx){
		//location.href = 
		window.open("../member/popup_sale_calc_view.php?idx="+idx+"","calcview", "top=100,left=100,scrollbars=yes,resizable=no,width=1080,height=600");
	}
