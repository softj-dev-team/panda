			...
			<div class="content">
				...
				<div class="navi">
					<ul class="clearfix">
						<li>HOME</li>
						<li>판매/정산 관리</li>
						<li><?=$v_sect_str?> 판매현황</li>
					</ul>
				</div>
				<div class="list_tit">
					<h3><?=$v_sect_str?> 판매리스트</h3>
				</div>
				<!-- 네비게이션 종료 -->
				<div class="list">
				<!-- 검색창 시작 -->
...
<script>
	...
	function go_sale_view(idx){
		//location.href = 
		<?if($v_sect == "general"){?>
			window.open("../member/popup_sale_offer_view.php?idx="+idx+"","saleview", "top=100,left=100,scrollbars=yes,resizable=no,width=1080,height=600");
		<?}elseif($v_sect == "auction"){?>
			window.open("../member/popup_sale_auction_view.php?idx="+idx+"","saleview", "top=100,left=100,scrollbars=yes,resizable=no,width=1080,height=600");
		<?}?>
	}
