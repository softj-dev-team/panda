...
<?
	...
	if($cate_level == 1){
		...
		if($result){
			error_frame_go("등록이 정상적으로 완료 되었습니다.","common_cate_list.php?bmenu=".$bmenu."&smenu=".$smenu."&s_type=".$type."&v_step=".$v_step."");
		} else {
		...
		if($result){
			error_frame_go("등록이 정상적으로 완료 되었습니다.","common_cate_list.php?bmenu=".$bmenu."&smenu=".$smenu."&s_type=".$type."&v_step=2&pageNo=".$pageNo."&field=".$field."&keyword=".$keyword."&cate_code1=".$cate_code1."");
		} else {
			error_frame("오류가 발생했습니다.");
		}
		...
		if($result){
			error_frame_go("등록이 정상적으로 완료 되었습니다.","common_cate_list.php?bmenu=".$bmenu."&smenu=".$smenu."&s_type=".$type."&v_step=3&pageNo=".$pageNo."&field=".$field."&keyword=".$keyword."&cate_code1=".$cate_code1."&cate_code2=".$cate_code2."");
		} else {
			error_frame("오류가 발생했습니다.");
		}
		...
		if($result){
			error_frame_go("등록이 정상적으로 완료 되었습니다.","common_cate_list.php?bmenu=".$bmenu."&smenu=".$smenu."&s_type=".$type."&v_step=3&pageNo=".$pageNo."&field=".$field."&keyword=".$keyword."&cate_code1=".$cate_code1."&cate_code2=".$cate_code2."&cate_code3=".$cate_code3."");
		} else {
			error_frame("오류가 발생했습니다.");
		}
