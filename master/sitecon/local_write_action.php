...
<? 
	...
	if($cate_level == 1){
		...
		<SCRIPT LANGUAGE="JavaScript">
			<!--
				...
				parent.location.href =  "local_list.php?bmenu=<?=$bmenu?>&smenu=<?=$smenu?>&v_step=<?=$v_step?>";
			//-->
		</SCRIPT>
	...
	<?
		...
		<SCRIPT LANGUAGE="JavaScript">
			<!--
				...
				parent.location.href =  "local_list.php?bmenu=<?=$bmenu?>&smenu=<?=$smenu?>&v_step=<?=$v_step?>&pageNo=<?=$pageNo?>&field=<?=$field?>&keyword=<?=$keyword?>&cate_code1=<?=$cate_code1?>";
			//-->
		</SCRIPT>
	...
	<?
		...
		<SCRIPT LANGUAGE="JavaScript">
			<!--
				alert('<?=$cate_str?> 등록이 정상적으로 완료 되었습니다.');
				parent.location.href =  "local_list.php?bmenu=<?=$bmenu?>&smenu=<?=$smenu?>&v_step=<?=$v_step?>&pageNo=<?=$pageNo?>&field=<?=$field?>&keyword=<?=$keyword?>&cate_code1=<?=$cate_code1?>&cate_code2=<?=$cate_code2?>";
			//-->
		</SCRIPT>
