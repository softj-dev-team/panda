		...
		<div class="sub_wrap">
			...
			<div class="container clearfix">
				<div class="content">
					...
					<div class="write">
						<p style="color:red; margin-bottom:10px;">배너위치 사이드바의 경우 최대 너비 : 120픽셀</p>
						...
						<td colspan="3">
							<input type="radio" name="section" id="section_1" onclick="section_ck();" required="yes"  message="배너구분" value="movie">동영상 &nbsp; <input type="radio" name="section" id="section_2" onclick="section_ck();" required="yes"  message="배너구분" value="img">이미지
								...
								<tr id="link_sect_txt4" style="display:;">
									<th>배너 이미지</th>
									<td colspan="3"><input type="file" id="inputPhoto" name="file1" style="width:50%;" required="no" message="배너 이미지" />&nbsp;<span id="banner_size_txt1" style="color:blue;"></span></td>
								</tr>
						...
						<td width="*" colspan="3">
							<input type="text" style="width:60%;" name="main_title" id="main_title" required="yes"  message="배너 타이틀">
								...
								<tr>
									<th>배너 텍스트</th>
									<td width="*" colspan="3">
										<textarea style="width:90%;height:80px;" name="main_memo" id="main_memo" required="yes" message="배너 텍스트"></textarea>
									</td>
								</tr>
