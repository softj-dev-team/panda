...
<?
	...
	if($result){
		error_frame_go($cate_str." 수정이 정상적으로 완료 되었습니다.","common_cate_list.php?bmenu=".$bmenu."&smenu=".$smenu."&s_type=".$type."&v_step=".$v_step."&pageNo=".$pageNo."&field=".$field."&keyword=".$keyword."&cate_code1=".$cate_code1."&cate_code2=".$cate_code2."&cate_code3=".$cate_code3."");
	} else {
