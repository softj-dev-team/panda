...
$memo = trim(sqlfilter(str_replace("-", "", $_REQUEST['memo'])));

$sql_pre1 = "select idx from spam_list where 1 and cell_num = '" . $cell_num . "'"; // 회원테이블 아이디 중복여부 체크
...
$query = "insert into spam_list set";
...
?>
	<SCRIPT LANGUAGE="JavaScript">
		...
		parent.location.href = "sms_spam_list.php?bmenu=<?= $bmenu ?>&smenu=<?= $smenu ?>";
		//
		-->
	</SCRIPT>
<? } else { ?>
