...
if($orgin_idx){
	$sql = "SELECT *,(select ad_title from ad_info where 1 and idx=a.product_idx) as ad_title FROM board_content a where 1 and idx = '".$idx."' ";
} else {
	$sql = "SELECT *,(select ad_title from ad_info where 1 and idx=a.product_idx) as ad_title FROM board_content a where 1 and idx = '".$idx."' and bbs_code='".$bbs_code."'";
}
...
<div id="wrap" class="skin_type01">
	...
	<div class="sub_wrap">
		...
		<div class="container clearfix">
			...
			<input type="hidden" name="pro_name" value="<?=$row[ad_title]?>"/>
			<input type="hidden" name="pro_idx" value="<?=$row[product_idx]?>"/>
			...
			<table class="t_view">
				...
				<?}?>
					...
					<tr>
						<th >프로그램선택</th>
						<td colspan="3"><span id="pro_name_txt"><?if($row[ad_file_chg]){?><img src='<?=get_ad_image($row[product_idx])?>' border='0'><?}?>&nbsp;<?=$row[ad_title]?></span>&nbsp;<a href="javascript:main_product_pop();" class="btn_green">프로그램찾기</a></td>
					</tr>

				<?if($bbs_code == "adreview" && !$orgin_idx){?>
					<tr>
						<th >프로그램평점</th>
						<td colspan="3">
							<input type="radio" required="yes" message="평점"  name="after_point" value="1" <?=$row[after_point]=="1"?"checked":""?>><img src="/img/icon/view_list_star_on.gif" width="13" height="13" />
							<input type="radio" required="yes" message="평점"  name="after_point" value="2" <?=$row[after_point]=="2"?"checked":""?>><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" />
							<input type="radio" required="yes" message="평점"  name="after_point" value="3" <?=$row[after_point]=="3"?"checked":""?>><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" />
							<input type="radio" required="yes" message="평점"  name="after_point" value="4" <?=$row[after_point]=="4"?"checked":""?>><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" />
							<input type="radio" required="yes" message="평점"  name="after_point" value="5" <?=$row[after_point]=="5"?"checked":""?>><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" /><img src="/img/icon/view_list_star_on.gif" width="13" height="13" />
						</td>
					</tr>
			<?}?>
					...
					<tr>
						...
						<td >
							<select name="bbs_sect" size="1" style="vertical-align:middle;" required="yes"  message="게시판 분류">
								...
								<option value="ad" <?=$row['bbs_sect']=="ad"?"selected":""?>>프로그램</option>
							</select>
						</td>-->
					</tr>
			<?}?>
