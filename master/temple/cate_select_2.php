...
<script> 
<? 
	$query = "select cate_code3,cate_name3 from viva_cate where 1 and set_code='advert' and cate_level = '3' and cate_code1='".$cate_code1."' and cate_code2='".$cate_code2."' order by cate_code3 asc"; 
