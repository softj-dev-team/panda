...
$point_sql = "select  * from member_point_set where 1=1 and coin_type='advert' and point_sect='".$point_sect."' order by idx desc limit 0,1"; // 가장 최근에 설정된 적립비율 설정내용을 가져온다.
...
<div id="wrap" class="skin_type01">
	...
	<div class="sub_wrap">
			...
			<a href="javascript:location.reload();" class="btn_refresh">새로고침</a>
				...
				<div class="write">
					...
					<div class="btn_wrap" style="margin-bottom:10px;">
						<b>프로그램관련 코인지급 설정입니다. 프로그램시청, 리뷰작성, 프로그램공유시 지급될 금액만 설정합니다.</b>
					</div>
		...
		<?} elseif($point_sect == "refund"){ // 코인지급일 경우 시작 ?>
				<colgroup>
					<col width="20%" />
					<col width="80%" />
				</colgroup>
				<tr>
					<th>좋아요 클릭시</th>
					<td>좋아요 클릭시 <input type="text" name="add_point_1" id="add_point_1" class="input_txt" style="width:100px;" value="<?= $point_row[add_point_1]?>"  required="yes" message="좋아요 클릭시" is_num="yes"/> 코인지급 (지급하지 않을경우 0 입력)</td>
				</tr>
				<tr>
					<th>리뷰작성시</th>
					<td>리뷰작성시 <input type="text" name="add_point_2" id="add_point_2" class="input_txt" style="width:100px;" value="<?= $point_row[add_point_2]?>"  required="yes" message="리뷰작성시" is_num="yes"/> 코인지급 (지급하지 않을경우 0 입력)</td>
				</tr>
				<tr>
					<th>프로그램공유시</th>
					<td>프로그램공유시 <input type="text" name="add_point_3" id="add_point_3" class="input_txt" style="width:100px;" value="<?= $point_row[add_point_3]?>"  required="yes" message="프로그램공유시" is_num="yes"/> 코인지급 (지급하지 않을경우 0 입력)</td>
				</tr>
