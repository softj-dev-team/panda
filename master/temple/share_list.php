...
$where = " and share_sect='adv' and is_del='N'";
...
if($field == "ad_title"){
	$where .= " and share_idx in (select idx from ad_info where 1 and ad_title like '%".$keyword."%')";
} elseif($field == "member"){
...
$query = "select *,(select ad_title from ad_info where 1 and idx=share_history.share_idx) as ad_title,(select user_name from member_info where 1 and idx=share_history.member_idx) as user_name FROM share_history where 1 ".$where.$order_by." limit ".$StarRowNum." , ".$EndRowNum;
						...
						<tr>
							...
							<td colspan="5">
								...
								<select name="field" size="1" style="vertical-align:middle;width:20%;">
									...
									<option value="ad_title" <?=$field=="ad_title"?"selected":""?>>프로그램제목</option>
