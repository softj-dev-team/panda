...
<?
	...
	$sql_pre2 = "select member_idx from temple_info where 1 and idx = '".$idx."' "; 
	...
	// 회원 사진 삭제
	$file_sql = "select file_chg from temple_info where 1=1 and idx = '".$idx."' ";
	...
	parent.location.href =  "temple_list.php?<?=$total_param?>";
	//-->
	</SCRIPT>
	<?}else{?>
	<SCRIPT LANGUAGE="JavaScript">
