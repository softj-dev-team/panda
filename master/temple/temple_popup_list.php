...
$query = "select *,(select temple_title from temple_info where 1 and is_del='N' and idx=popup_div.temple_idx) as temple_title from popup_div where 1".$where.$order_by." limit ".$StarRowNum." , ".$EndRowNum;

//echo "<br><br>쿼리 = ".$query."<br><Br>";

$result = mysqli_query($gconnet,$query);

$query_cnt = "select idx from popup_div where 1 ".$where;
...
<!--
	function go_view(no){
		location.href = "temple_popup_view.php?idx="+no+"&pageNo=<?=$pageNo?>&<?=$total_param?>";
	}
	...
	function go_regist(){
		location.href = "temple_popup_write.php?<?=$total_param?>";
	}
		...
		<div class="container clearfix">
			<div class="content">
				...
				<div class="list">
					<!-- 검색창 시작 -->
					<table class="search">
					<form name="s_mem" method="post" action="temple_popup_list.php">
