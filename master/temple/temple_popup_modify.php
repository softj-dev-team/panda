...
$sql = "SELECT * FROM popup_div where 1=1 and idx='".$idx."' and temple_idx is not null and temple_idx != ''";
...
<SCRIPT LANGUAGE="JavaScript">
	<!--
	alert('해당하는 팝업이 없습니다.');
	location.href =  "temple_popup_list.php?<?=$total_param?>";
	//-->
</SCRIPT>
<?
exit;
...
<div id="wrap" class="skin_type01">
	...
	<div class="sub_wrap">
		...
		<div class="container clearfix">
			...
			<form name="frm" action="temple_popup_modify_action.php" target="_fra_admin" method="post"  enctype="multipart/form-data">
			...
			<table class="t_view">
				...
				<tr>
					...
					<tr>
						<th >팝업 시작일</th>
						<td ><input type="text" name="startdt" style="width:10%;" id="startdt" onClick="new CalendarFrame.Calendar(this)" value="<?=$row[startdt]?>" required="yes" message="팝업 시작일" readonly style="vertical-align:middle;"></td>
					</tr>
					<tr>
						<th >팝업 종료일</th>
						<td ><input type="text" name="enddt" style="width:10%;" id="enddt" onClick="new CalendarFrame.Calendar(this)" value="<?=$row[enddt]?>" required="yes" message="팝업 종료일" readonly style="vertical-align:middle;"></td>
					</tr>
...
var oEditors = [];
	...
	function go_list(){
		location.href = "temple_popup_view.php?idx=<?=$idx?>&<?=$total_param?>";
	}
</script>
