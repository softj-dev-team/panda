...
<!--
function go_view(no){
		location.href = "temple_popup_view.php?idx="+no+"&<?=$total_param?>";
}
	
function go_modify(no){
		location.href = "temple_popup_modify.php?idx="+no+"&<?=$total_param?>";
}
...
function go_delete(no){
	if(confirm('정말 삭제 하시겠습니까?')){
		...
		if(confirm('삭제하신 데이터는 복구할수 없도록 영구 삭제 됩니다. 그래도 삭제 하시겠습니까?')){	
			_fra_admin.location.href = "temple_popup_delete_action.php?idx="+no+"&<?=$total_param?>";
		}
	}
}
		...
		<div class="container clearfix">
			...
			<table class="t_view">
				...
				<tr>
					...
					<form name="frm" action="temple_popup_view_action.php" target="_fra_admin" method="post" >
