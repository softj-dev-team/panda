...
<?
	...
	$prev_sql = "select idx from temple_info where 1=1 and idx = '".$idx."' and is_del = 'N' ";
	...
	parent.location.href =  "temple_view.php?idx=<?=$idx?>&<?=$total_param?>";
	//-->
	</SCRIPT>
	<?}else{?>
	<SCRIPT LANGUAGE="JavaScript">
