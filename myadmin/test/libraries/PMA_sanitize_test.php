...
class PMA_sanitize_test extends PHPUnit_Framework_TestCase
{
    ...
    public function testLink()
    {
        ...
        $this->assertEquals(
            '<a href="./url.php?url=https%3A%2F%2Fwww.phpmyadmin.net%2F&amp;token=token" target="target">link</a>',
    ...
    {
        $this->assertEquals(
            '<a href="./url.php?url=https%3A%2F%2Fdocs.phpmyadmin.net%2F&amp;token=token">doc</a>[a@javascript:alert(\'XSS\');@target]link</a>',
