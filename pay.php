        ...
        <form name="frm_pay" id="frm_pay" method="post" enctype="multipart/form-data">
            ...
            <div>
                <ul id="pay_price" class="pay_price_flex">
                    <li><input type="radio" class="input_radio" value="10000" name="price" required="yes" message="결제 금액"> 10,000원</li>
                    <li><input type="radio" class="input_radio" value="50000" name="price" required="yes" message="결제 금액"> 50,000원</li>
                    <li><input type="radio" class="input_radio" value="100000" name="price" required="yes" message="결제 금액"> 100,000원</li>
                    <li><input type="radio" class="input_radio" value="300000" name="price" required="yes" message="결제 금액"> 300,000원</li>
                    <li><input type="radio" class="input_radio" value="500000" name="price" required="yes" message="결제 금액"> 500,000원</li>
                    <li><input type="radio" class="input_radio" value="1000000" name="price" required="yes" message="결제 금액"> 1,000,000원</li>
                    <li><input type="radio" class="input_radio" value="3000000" name="price" required="yes" message="결제 금액"> 3,000,000원</li>
                    <li><input type="radio" class="input_radio" value="5000000" name="price" required="yes" message="결제 금액"> 5,000,000원</li>
                    <!--
                    <li><input type="radio" class="input_radio" value="-1" name="price" id="price_5" required="yes" message="결제 금액"> 기타</li>
                    <li><input type="text" name="price_other" id="price_other" placeholder="기타금액(원)" required="no" message="기타금액(원)" is_num="yes"></li>
-->
                </ul>
            </div>
        ...
        function go_pay_request() {
            ...
            if (check) {
                ...
                if (purchase_type == "dirbank") {
                    ...
                    $("#frm_pay").attr("action", "pay_update.php");
                }
                $("#frm_pay").submit();
            } else {
                false;
