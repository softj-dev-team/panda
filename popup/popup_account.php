	...
	<div class="popup_wrap">
		...
		<div class="price_box">
			<dl>
				...
				<dd class="total">
					총 금액 <span><?=number_format($row[payment_total_price]+$row[delev_price])?></span>원
				</dd>
			</dl>
		</div>
		...
		<div class="popup_b">
			...
			<div class="btn_wrap">
				<button type="button" class="btn_gray" onclick="print_this();">거래명세표 인쇄</button>
...
<!--
function print_this(){
	window.open('popup_account_print.php?mode=<?=$mode?>&mode_sub=<?=$mode_sub?>&idx=<?=$idx?>','popup','width=650, height=750, left=200, top=100, scrollbars=no');
}
//-->
</script>
