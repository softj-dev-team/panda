...
$query = "select bjd_code,k_name from code_bjd where 1 and filter='SGG' and del_yn='N' and pre_code='".$cate_code1."' order by idx asc"; 
//echo $query."<br>";
...
//$("#<?=$fname?>", parent.document).prop("selected",false);
//$("#<?=$fname?>", parent.document).find('option:first').attr('selected', 'selected');
</script> 
