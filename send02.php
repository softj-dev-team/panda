...
$where = " and member_idx='" . $member_idx . "' and transmit_type='send' and is_del='N' and reserv_yn='Y' and CONCAT(reserv_date,' ',reserv_time,':',reserv_minute) > '" . date("Y-m-d H:i") . "'";
...
<body>
    ...
    <section class="sub">
        ...
        <div class="tab_btn_are">
            ...
            <form name="s_mem" id="s_mem" method="post" action="send02.php">
                <div class="input_tab">
            ...
            <div class="btn">
                <a href="javascript:go_tot_del();">예약전송취소</a>
            </div>
                ...
                <table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:left;"><?= $row['sms_content'] ?></td>
    ...
    <script>
        ...
        function go_tot_del() {
            ...
            if (check) {
                if (confirm('선택하신 예약전송을 취소 하시겠습니까?')) {
